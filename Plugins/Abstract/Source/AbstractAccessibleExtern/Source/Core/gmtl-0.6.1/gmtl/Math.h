...
namespace Math
{
    ...
    *  @{
    */
   const float GMTL_TWO_PI = 6.28318530717958647692f;
   const float GMTL_PI = 3.14159265358979323846f; //3.14159265358979323846264338327950288419716939937510;
   const float GMTL_PI_OVER_2 = 1.57079632679489661923f;
   const float GMTL_PI_OVER_4 = 0.78539816339744830962f;
   /** @} */
...
inline float aCos( float fValue )
{
    ...
    {
        return static_cast<float>(gmtl::Math::GMTL_PI);
    }
}
inline double aCos( double fValue )
{
    ...
    {
        return static_cast<double>(gmtl::Math::GMTL_PI);
    }
}
//----------------------------------------------------------------------------
template <typename T>
...
inline float aSin( float fValue )
{
    if ( -1.0f < fValue )
    {
        if ( fValue < 1.0f )
        {
            ...
            return static_cast<float>(-gmtl::Math::GMTL_PI_OVER_2);
    }
    else
    {
        return static_cast<float>(gmtl::Math::GMTL_PI_OVER_2);
...
inline double aSin( double fValue )
{
    if ( -1.0 < fValue )
    {
        if ( fValue < 1.0 )
            ...
            return static_cast<double>(-gmtl::Math::GMTL_PI_OVER_2);
    }
    else
    {
        return static_cast<double>(gmtl::Math::GMTL_PI_OVER_2);
...
{
   return static_cast<float>(fVal * static_cast<float>(gmtl::Math::GMTL_PI / 180.0));
}
inline double deg2Rad( double fVal )
{
   return static_cast<double>(fVal * static_cast<double>(gmtl::Math::GMTL_PI / 180.0));
}

inline float rad2Deg( float fVal )
{
   return static_cast<float>(fVal * static_cast<float>(180.0 / gmtl::Math::GMTL_PI));
}
inline double rad2Deg( double fVal )
{
   return static_cast<float>(fVal * static_cast<double>(180.0 / gmtl::Math::GMTL_PI));
}
//----------------------------------------------------------------------------
