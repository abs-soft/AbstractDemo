...
//      gmtl::Vec3f xAxis1, yAxis1, zAxis1;
      ...
      for (float x = -gmtl::Math::GMTL_PI; x < gmtl::Math::GMTL_PI; x += 0.2)
      for (float y = -gmtl::Math::GMTL_PI; y < gmtl::Math::GMTL_PI; y += 0.2)
      for (float z = -gmtl::Math::GMTL_PI; z < gmtl::Math::GMTL_PI; z += 0.2)
      {
         // more complex rotation
